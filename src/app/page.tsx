...
export default function Home() {
  return (
    <div className="bg-white min-h-screen p-8 mt-14">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-5">
        <div className="h-[600px] md:h-[550px] bg-[#fcfbf5] p-8 rounded-3xl shadow-lg justify-center md:col-span-8 transition-all hover:scale-[1.01]">
          ...
          <p className="text-stone-800 text-lg mb-6 pt-1">
            I&apos;m passionate about using design as a tool to inspire and
            create real connections. To me, great design isn&apos;t just about
            functionality—it&apos;s about creating experiences that are
            meaningful and visually exciting. <br /> I strive to code interfaces
            that are not only responsive and user-friendly but also crafted with
        ...
        <Link href="/projects" className="block">
          <div className="bg-[#f23f39] text-white p-6 rounded-3xl shadow-lg flex flex-col h-full hover:scale-[1.01]">
            ...
            <div className=" text-lg flex justify-end items-center gap-4">
              ...
              <span className="bg-white text-[#f23f39] px-5 py-2 rounded-full transition-all hover:scale-110 active:scale-95">
                →
              </span>
            </div>
          </div>
      ...
      <div className="text-left text-stone-400 text-sm pr-4">
        © {new Date().getFullYear()} Ida Hägerth
      </div>
    </div>
  );
}
